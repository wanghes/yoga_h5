...
export default {
    ...
    mounted() {
        ...
        this.currentDateStr = this.currentDate.getFullYear() + '年' + (this.currentDate.getMonth() + 1) + '月';
    },
    methods: {
        async fetchData() {
            ...
            if (cardRes.code == 200) {
                ...
                if (this.mainCard) {
                    ...
                    if (type == 1) {
                        ...
                        let m2 = moment(new Date(open_end_time.slice(0,10).replace(/-/g, '/')));
                        ...
                        this.mainCard.leave = "￥" + this.mainCard.surplus.toFixed(2) + "元"
                    } else if (type == 7) {
                        this.mainCard.leave = this.mainCard.surplus.toFixed(2) + "小时"
                    }
                }
        ...
        onConfirm(time) {
            this.currentDateStr = time.getFullYear() + '年' + (time.getMonth() + 1) + '月';;
