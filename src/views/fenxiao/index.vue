<template>
    <div class="wrap fenxiao">
        ...
        <div class="money">
            ...
            <!-- <div class="item">
                <span class="title">社群套餐</span>
                <span class="price"><i>￥</i>1888元<i>/年</i></span>
                <span class="active">限时促销</span>
                <span class="old">原价<del>3680</del>元</span>
            </div> -->
        </div>
...
<script>
const head_01 = require("@/assets/img/fenxiao/head_01.png");
const head_02 = require("@/assets/img/fenxiao/head_02.png");
const head_03 = require("@/assets/img/fenxiao/head_03.png");
const head_04 = require("@/assets/img/fenxiao/head_04.png");
const xiao_01 = require("@/assets/img/fenxiao/xiao_01.png");
const xiao_02 = require("@/assets/img/fenxiao/xiao_02.png");
const xiao_03 = require("@/assets/img/fenxiao/xiao_03.png");
const xiao_04 = require("@/assets/img/fenxiao/xiao_04.png");
const xiao_05 = require("@/assets/img/fenxiao/xiao_05.png");
const xiao_06 = require("@/assets/img/fenxiao/xiao_06.png");
const k_01 = require("@/assets/img/fenxiao/k_01.png");
const k_02 = require("@/assets/img/fenxiao/k_02.png");
const k_03 = require("@/assets/img/fenxiao/k_03.png");
const box_04_head = require("@/assets/img/fenxiao/box_04_head.png");
const bg = require("@/assets/img/fenxiao/bg.png");
const yin = require("@/assets/img/fenxiao/yin.png");
const t_01 = require("@/assets/img/fenxiao/t_01.png");
const t_02 = require("@/assets/img/fenxiao/t_02.png");
const t_03 = require("@/assets/img/fenxiao/t_03.png");
const t_04 = require("@/assets/img/fenxiao/t_04.png");
const t_05 = require("@/assets/img/fenxiao/t_05.png");
const t_06 = require("@/assets/img/fenxiao/t_06.png");
const b_01 = require("@/assets/img/fenxiao/b_01.png");
const b_02 = require("@/assets/img/fenxiao/b_02.png");
const b_03 = require("@/assets/img/fenxiao/b_03.png");
const b_04 = require("@/assets/img/fenxiao/b_04.png");
const b_05 = require("@/assets/img/fenxiao/b_05.png");
...
.inner_box{
    ...
    background-image: url('../../assets/img/fenxiao/z_bg.png');
    display: flex;
...
.tanchu_01{
    ...
    .b_con_01{
        background-image: url('../../assets/img/fenxiao/b_11.png');
    }
    .b_con_02{
        background-image: url('../../assets/img/fenxiao/b_22.png');
    }
    .b_con_03{
        background-image: url('../../assets/img/fenxiao/b_33.png');
    }
    .b_con_04{
        background-image: url('../../assets/img/fenxiao/b_44.png');
    }
    .b_con_05{
        background-image: url('../../assets/img/fenxiao/b_55.png');
    }
    .b_con_06{
        background-image: url('../../assets/img/fenxiao/b_66.png');
    }
    .close{
        width:20px;
        height: 20px;
...
.fenxiao{
    width:100%;
    // height: 100vh;
    background-image: url('../../assets/img/fenxiao/top.png');
...
.box_01{
    .title{
        background-image: url("../../assets/img/fenxiao/title_01.png");
    }
    .bot{
        display: flex;
        justify-content: center;
...
.box_02{
    .title{
        background-image: url("../../assets/img/fenxiao/title_02.png");
    }
    .sec{
        text-align: center;
        line-height: 30px;
...
.box_03{
    ...
    .title{
        ...
        background-size: contain;
        background-repeat: no-repeat;
        background-image: url("../../assets/img/fenxiao/title_03.png");
    }
    .item{
        margin-bottom: 15px;
        display: flex;
...
.box_04{
    margin-top: 15px;
    .title{
        background-image: url("../../assets/img/fenxiao/title_04.png");
    }
    ...
    .s_inner{
        ...
        display: flex;
        flex-direction: column;
        background-image: url("../../assets/img/fenxiao/bg.png");
        background-repeat: no-repeat;
...
.box_05{
    .title{
        background-image: url("../../assets/img/fenxiao/title_05.png");
    }
    .con{
        padding: 15px 0;
        display: flex;
