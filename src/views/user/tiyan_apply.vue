<template>
    <div class="wrap tiyan_box">
        ...
        <van-form @submit="onSubmit">
            ...
            <van-field readonly clickable name="start_time" :value="form.start_time" label="时间" placeholder="点击选择上课时间" @click="showTimePicker = true" />
            <van-popup v-model="showTimePicker" position="bottom">
                <van-picker show-toolbar @confirm="onConfirmTime" :columns="times" />
            </van-popup>
            <van-field v-model="form.price" name="price" label="价格" disabled placeholder="价格" />
            <van-field v-model="form.username" name="username" label="姓名" placeholder="姓名必填" :rules="[{ required: true, message: '请输入姓名' }]" />
